	...
	<body>
		...
		<div class="container">
			<form action="" method="POST">
				<div class="row">
					<div class="col-6">
						<input type="text" name="search" class="form-control" placeholder="Search by Area" value="<?php echo $searchKey ?>" >
						<br>
					</div>
					<div class="col-6">
						<input type="text" name="search1" class="form-control" placeholder="Search by Blood Group"    value="<?php echo $searchKey1 ?>" >
					</div>
					<div class="col-6">
